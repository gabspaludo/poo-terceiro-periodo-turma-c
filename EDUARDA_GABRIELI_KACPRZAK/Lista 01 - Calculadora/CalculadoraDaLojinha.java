        ...
        while (opc.equals("S") || opc.equals("s")) {
            ...
            while (choice != 4) {
                ...
                try {
                    ...
                    switch (choice) {
                        case 1:
                            ProductsSale sale = new ProductsSale(0, 0.0, 0.0, 0.0);
                            ...
                            boolean discountApplied = sale.getQuantity() >= 10;
                                if (discountApplied) {
                                    ...
                                    System.out.printf("\nValor total da compra com desconto: R$%.2f", sale.getDiscountOffered());
                                    } else {
                                        System.out.println("\n-------------------------------------------");
                                        System.out.println("\nResumo da compra: ");
                            ...
                            case 2:
                                ProductsSale changeSale = new ProductsSale(0, 0, 0, 0.0);
                                ...
                                if (amountReceived < changeSale.getPrice()) {
                                    System.out.println("\n-------------------------------------------");
                                    System.out.printf("\nAviso: Faltam R$%.2f para completar o pagamento", (changeSale.getPrice() - amountReceived));
                                    } else {
                                        System.out.println("\n-------------------------------------------");
                            ...
                            case 3:
                                ...
                                for (int i = 0; i < recordSales.size(); i++) {
                                    ...
                                    if (currentSale.getDiscountOffered() > 0) {
                                        ...
                                        System.out.printf("Valor total com Desconto Aplicado: R$%.2f%n ", currentSale.getDiscountOffered());
                                        } else {
                                            System.out.println("\nSem desconto.");
