...
public class GeneretedClass {
    ...
    public static Endereco gerarEndereco() {
        return Endereco.EnderecoBuilderLista06.builder()
                .estado(Estado.PR)
                .cidade("Cascavel")
                .bairro(gerarBairro())
                .rua(gerarRua())
    ...
    public static Cliente cliente() {
        return Cliente.ClienteBuilderLista06.builder()
                .nome(gerarNome())
                .idade(gerarIdade())
    ...
    public static Vendedor vendedor() {
        return Vendedor.VendedorBuilderLista06.builder()
                .nome(gerarNome())
                .idade(gerarIdade())
    ...
    public static Gerente gerente() {
        return Gerente.GerenteBuilderLista06.builder()
                .nome(gerarNome())
                .idade(gerarIdade())
                .salarioBase(gerarSalario())
                .salarioRecebido(List.of(gerarSalario(), gerarSalario(), gerarSalario()))
    ...
    public static Loja loja(List<Cliente> clientes, List<Vendedor> vendedors, List<Gerente> gerentes) {
        return Loja.LojaBuilderLista06.builder()
    ...
    public static ItemCompra itemCompra() {
        return ItemCompra.ItemCompraBuilderLista06.builder()
                .id(idItemCompra++)
    ...
    private static double gerarPrecoProduto() {
         return RANDOM.nextDouble(0.99, 500);
    }
}
