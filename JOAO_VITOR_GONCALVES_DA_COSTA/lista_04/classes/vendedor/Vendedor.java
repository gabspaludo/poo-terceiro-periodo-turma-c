package lista_04.classes.vendedor;

import lista_04.classes.loja.Loja;
import lista_04.classes.pessoa.Pessoa;
...
public class Vendedor extends Pessoa {
  ...
  public Vendedor(String nome, String bairro, String cidade, String rua, int idade, int quantidadeDeSalariosRecebidos,
      double salarioBase) {
