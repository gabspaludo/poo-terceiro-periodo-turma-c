...
import lista_06.classes.menu.Menu;

public class Teste {

        public static Long diaDeHoje = new Date().getTime();
        public static Long umDiaEmMs = 86400000l;
        public static Cliente cliente_01 = new Cliente("Sandro", 44, "Tropical", "Cascavel", "Amor", "Paraná",
                        "apto 1215",
                        "441");
        public static Loja loja_03 = new Loja("As Plantas", "14.131.182/4123-05", "Centro", "Passo Fundo", "Av. Dog",
                        "Rio Grande do Sul", " 256", "nenhum complemento", "Plantinhas da veia", 2, 2);
        public static Vendedor vendedores_03 = new Vendedor("Sandro", 50, "Pocs", "Cascavel", "Tereza", "Paraná",
                        "apto 89",
                        "42", 4, 2000);
        ...
        public static void run() {
                ...
                System.out.println(item_01.gerarDescricao());
                System.out.println("\n");
                System.out.println(item_02.gerarDescricao());
                System.out.println("\n");
                System.out.println(item_03.gerarDescricao());
                System.out.println("\n");
                ...
                System.out.println(pedido_01.gerarDescricaoVenda());
                System.out.println("\n");

                System.out.println(pedido_02.gerarDescricaoVenda());
                System.out.println("\n");

                System.out.println(pedido_03.gerarDescricaoVenda());
                System.out.println("\n");

                System.out.println(pedido_04.gerarDescricaoVenda());
                System.out.println("\n");

                System.out.println(pedido_05.gerarDescricaoVenda());
                System.out.println("\n");
