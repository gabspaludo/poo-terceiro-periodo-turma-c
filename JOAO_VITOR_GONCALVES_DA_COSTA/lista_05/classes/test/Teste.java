...
public class Teste {
  public static void run() {
    ...
    Cliente cliente_03 = new Cliente("Barcelos", 23, "Inter", "Cascavel", "Gurizas", "Paraná", "casa", "432");

    Cliente cliente_04 = new Cliente("Ben", 35, "Flu", "Cascavel", "Criantes", "Paraná", "apto 512", "111");

    Cliente cliente_05 = new Cliente("Marcio", 32, "Jax", "Cascavel", "Luffy", "Rio Grande do Sul", "apto 543", "244");
    ...
    Vendedor vendedores_04 = new Vendedor("Sandro", 25, "Tropical", "Cascavel", "Fortaleza", "Paraná", "apto 1215",
        "12", 3, 1250);
    vendedores_04.adicionarSalarios(1250, 6532, 4959);

    Vendedor vendedores_05 = new Vendedor("Sandro", 33, "Caltropil", "Passo fundo", "Fortaleza", "Paraná", "apto 5",
        "534", 3, 899);
    vendedores_05.adicionarSalarios(1250, 6532, 4959);

    Vendedor vendedores_06 = new Vendedor("Sandro", 44, "Poloas", "Curitiba", "Fortaleza", "Paraná", "apto 321",
        "413", 3, 789);
    ...
    gerente_01.adicionarSalarios(4530, 4323, 4530);
    gerente_01.setLojaEmqueTrabalha(loja_01);

    Gerente gerente_02 = new Gerente("Cleberilda", 59, "Abare", "Passo Fundo", "Fortaleza", "Rio Grande do Sul",
        "apto 1",
        "978", 12, 5000);

    gerente_02.setLojaEmqueTrabalha(loja_02);
    gerente_02.adicionarSalarios(4530, 4323, 6177, 4589, 7894, 4530, 9878, 1587, 4530, 6789);
